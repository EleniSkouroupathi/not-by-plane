notplaneapp.controller('noPlaneController',['$resource',function($resource) {
  ...
  self.getFlightFromLoc = function(startLoc,endLoc,startDate,endDate) {
    searchResource = $resource(lowFareSearch+'?'+'apikey='+API_key+'&origin='+startLoc+'&destination='+endLoc+'&departure_date='+startDate+'&return_date='+endDate);
